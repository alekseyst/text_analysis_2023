...
* Если нужно, настройте кодировку (меню Global Settings — Char Encoding). Чтобы слова с дефисами считались одним токеном, выберите Connector и Dash в меню File — Open Corpus Manager — Raw File(s) — Basic Settings — Show Token Definition Settings — Unicode Punctuation.
